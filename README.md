...
> My project is about setting up the basic config for lintr and other tools that will be used in the program
...
- **adding h1 title**
- **adding color using css to the title**
...
> this project for testing purpose of lintr
...
```sh
  cd my-folder
  git clone https://github.com/ahmedeid6842/Hello-Microverse.git
```
